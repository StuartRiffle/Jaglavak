...
public:
    ...
    const UciOptionInfo* GetOptionInfo()
    {
        ...
        static UciOptionInfo sOptions[] = 
        {
            ...
            OPTION_INDEX( mMaxTreeNodes ),      "MaxTreeNodes",     0, 1000000, 100000,
            ...
            OPTION_INDEX( mCudaQueueDepth ),    "CudaQueueDepth",       0, 8192, 64,
            OPTION_INDEX( mPlayoutPeekMoves ),  "PlayoutPeekMoves",     0, 1000, 3,
            OPTION_INDEX( mPlayoutErrorRate ),  "PlayoutErrorRate",     0, 100,  90,
            OPTION_INDEX( mPlayoutMaxMoves ),   "PlayoutMaxMoves",      0, 1000, 100,
            OPTION_INDEX( mMaxPendingJobs ),    "MaxPendingJobs",       0, 1000000, 64,
