...
public:
    ...
    const UciOptionInfo* GetOptionInfo()
    {
        ...
        static UciOptionInfo sOptions[] = 
        {
            ...
            OPTION_INDEX( mNumAsyncPlays ),     "NumAsyncPlayouts",     0, 10000, 20,
            ...
            OPTION_INDEX( mCudaJobBatch   ),    "CudaJobBatch",         0, 8192, 128,
            ...
            OPTION_INDEX( mMaxPendingJobs ),    "MaxPendingJobs",       0, 1000000, 100,
            OPTION_INDEX( mNumCpuWorkers ),     "NumCpuWorkers",        1, 10, 4,
