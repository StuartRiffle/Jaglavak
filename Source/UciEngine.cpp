...
const UciOptionInfo* UciEngine::GetOptionInfo()
{
    ...
    static UciOptionInfo sOptions[] = 
    {
        ...
        OPTION_INDEX( MaxInitialPlayouts ),     0,          0,          
        OPTION_INDEX( MaxAsyncPlayouts ),       0,          16,         
        OPTION_INDEX( MaxPlayoutMoves ),        0,          200,        
        OPTION_INDEX( MinPendingBatches ),      0,          128,        
        OPTION_INDEX( MaxPendingBatches ),      0,          1024,        
        OPTION_INDEX( MinBatchSize ),           0,          128,       
        OPTION_INDEX( MaxBatchSize ),           0,          1024,       
        OPTION_INDEX( MaxTreeNodes ),           0,          1000000,    
        OPTION_INDEX( NumWarmupLevels ),        0,          20,       
        ...
        OPTION_INDEX( UciUpdateDelay ),         0,          200,          
        -1
    };
