...
const char* Embedded_DefaultSettings = R"EMBEDDED_FILE(
{
    ...
    "CPU.DispatchThreads":      { "value": 0,       "desc": "" },
    "CPU.SearchFibers":         { "value": 100,      "desc": "" },       
    ...
    "Search.VirtualLoss":       { "value": 0.1,     "desc": "" },  


    "UCI.TimeSafetyMargin":     { "value": 100,     "desc": "" },        
    "UCI.UpdateTime":           { "value": 5000,     "desc": "" }
}
